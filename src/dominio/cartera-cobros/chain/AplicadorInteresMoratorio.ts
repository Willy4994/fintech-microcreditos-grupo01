...
export class AplicadorInteresMoratorio extends AplicadorPago {
  constructor(private readonly deudaMoratoria: Dinero) {
    super();
  }
  ...
  protected aplicarConcepto(
    ...
    const deuda = this.deudaMoratoria.obtenerCentavos();
