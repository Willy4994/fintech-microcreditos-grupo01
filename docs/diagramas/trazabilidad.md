...
| R7: Gestionar el ciclo de vida reversible del crédito | Actualizar estado del crédito | Credito · EstadoCredito · CambioEstadoCredito · TramoMora |
...
| R10: Mantener trazabilidad financiera y de estados | Consultar movimientos / historial | Movimiento · CambioEstadoCredito · Credito · Cierre |
